...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $sql = "SELECT id_color FROM color WHERE ";
    $sql = $sql . "color_des='" . $_POST["color_des"] . "'";
    $result = $conn->query($sql);
    if($result->num_rows == 0) {
        $sql = "INSERT INTO color (";
        $sql = $sql . "color_des";
        $sql = $sql . ") VALUES (";
        $sql = $sql . "'" . $_POST["color_des"] . "')";
        $conn->query($sql);
        $id_color = $conn->insert_id;
//        echo "added id_color = " . $id_color;
    } else {
        $row = $result->fetch_assoc();
        $id_color = $row["id_color"];
//        echo "matched id_color = " . $id_color;
    }
    ...
    $sql = $sql . "id_op,";
    $sql = $sql . "id_rawmat,";
    $sql = $sql . "qty_required,";
    $sql = $sql . "qty_allocated,";
    $sql = $sql . "qty_picked,";
    $sql = $sql . "qty_issued,";
    $sql = $sql . "qty_open,";
    $sql = $sql . "date_issue_rawmat,";
    $sql = $sql . "id_color,";
    $sql = $sql . "note_des";
    $sql = $sql . ") VALUES (";
    $sql = $sql . "" . $_POST["id_job"] . ",";
    $sql = $sql . "" . $_POST["id_op"] . ",";
    $sql = $sql . "'" . $_POST["id_rawmat"] . "',";
    $sql = $sql . "" . $_POST["qty_required"] . ",";
    $sql = $sql . "" . $_POST["qty_allocated"] . ",";
    $sql = $sql . "" . $_POST["qty_picked"] . ",";
    $sql = $sql . "" . $_POST["qty_issued"] . ",";
    $sql = $sql . "" . $_POST["qty_open"] . ",";
    $sql = $sql . "'" . $_POST["date_issue_rawmat"] . "',";
    $sql = $sql . "" . $id_color . ",";
    $sql = $sql . "'" . $_POST["note_des"] . "')";
//    echo $sql;
    $conn->query($sql);
}
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <div class="sidenav-menu-heading">Rawmats</div>
                            <!-- Sidenav Accordion (Dashboard)-->
                            <a class="nav-link" href="../pp-routecard-add-rawmat.php">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-xl px-4 mt-n10">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">Rawmats</div>
                            <div class="card-body">
