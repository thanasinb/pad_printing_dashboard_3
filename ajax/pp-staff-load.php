...
$sql = "SELECT staff.id_staff, staff.id_rfid, prefix.prefix, staff.site, role.role, staff.id_shif FROM staff INNER JOIN role ON staff.id_role=role.id_role INNER JOIN prefix ON staff.prefix=prefix.id_prefix WHERE id_staff='" . $_GET['id_staff'] . "'";
