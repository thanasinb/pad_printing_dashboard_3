<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $sql = "INSERT IGNORE INTO operation (";
        $sql = $sql . "id_job,";
        $sql = $sql . "id_op,";
        $sql = $sql . "op_des,";
        $sql = $sql . "work_ctr,";
        $sql = $sql . "date_start_op,";
        $sql = $sql . "date_due_op,";
        $sql = $sql . "exp_date_finish,";
        $sql = $sql . "exp_time_finish,";
        $sql = $sql . "std_setup,";
        $sql = $sql . "std_run,";
        $sql = $sql . "qty_open,";
        $sql = $sql . "time_run,";
        ...
        $sql = $sql . "" . $_POST["id_op"] . ",";
        $sql = $sql . "'" . $_POST["op_des"] . "',";
        $sql = $sql . "" . $_POST["work_ctr"] . ",";
        $sql = $sql . "'" . $_POST["date_start_op"] . "',";
        $sql = $sql . "'" . $_POST["date_due_op"] . "',";
        $sql = $sql . "'" . $_POST["exp_date_finish"] . "',";
        $sql = $sql . "'" . $_POST["exp_time_finish"] . "',";
        $sql = $sql . "" . $_POST["std_setup"] . ",";
        $sql = $sql . "" . $_POST["std_run"] . ",";
        $sql = $sql . "" . $_POST["qty_open"] . ",";
        $sql = $sql . "'" . $_POST["time_run"] . "',";
        $sql = $sql . "" . $_POST["yield"] . ",";
        $sql = $sql . "" . $_POST["qty_exp1"] . ",";
        $sql = $sql . "" . $_POST["qty_exp2"] . ",";
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <a class="nav-link" href="../pp-routecard-add-operation.php">
