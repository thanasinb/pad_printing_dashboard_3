            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table id="modal_table" class="table table-striped">
                        ...
                        <tr>
                            <td>RFID</td>
                            <td id="modal_rfid"><input type="text" id="input_rfid" name="input_rfid" maxlength="10" autocomplete="off" onkeypress="return validRfid(event)" disabled> <div id="rfid_response"></div> </td>
                            <td>
